...
cMsysWindowManager::cMsysWindowManager()
{
}
...
bool cMsysWindowManager::Create(HINSTANCE _hInstance)
{
...
bool cMsysWindowManager::Destroy()
{
...
LRESULT cMsysWindowManager::MainWndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	switch (uMsg)
	{
	case WM_DESTROY:
...
HWND cMsysWindowManager::GetWindowHandle()
{
	return m_hwnd;
}
